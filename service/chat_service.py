...
from llm.prompts import build_oa_messages
    ...
    async def stream_answer(self,conversation_id:UUID,question:str)->AsyncIterator[SseIterator]:
        ...
        try:
            ...
            if megs:
                ...
                redis_client.set(str(conversation_id),_message_adapter.dump_json(megs).decode("utf-8"))
...
async def stream_chat(copy_rag_document_state:CopyRagDocumentState)->AsyncIterator[SseIterator]:
    ...
    messages = build_oa_messages(intent,chunks,question_rewrite,history)
