...
from sqlalchemy import UUID, Text, DateTime, func, Computed, ForeignKey, VARCHAR, String, BigInteger
...
class DocumentChunk(Base):
    ...
    chunk_metadata:Mapped[dict] = mapped_column(Text,nullable=False)
    create_at :Mapped[datetime] = mapped_column(DateTime(timezone=True),default=func.now(),nullable=False)
